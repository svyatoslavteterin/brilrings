...
$kale_defaults['kale_frontpage_featured_posts_heading'] = esc_html__('Избранные статьи', 'kale');
...
$kale_defaults['kale_frontpage_large_post_heading']     = esc_html__('Наши статьи', 'kale');
...
$kale_defaults['kale_blog_feed_label']                  = __('Последние статьи', 'kale');
